...
#define SET_INT()	GPIO_SetBits(GPIOB, GPIO_Pin_14);
#define CLR_INT()	GPIO_ResetBits(GPIOB, GPIO_Pin_14);
#define Is_INT_IN  GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_14) //PB.14

/*RESET*/
#define PORT_RST	GPIOB
#define PIN_RST		GPIO_Pin_12
#define SET_RST()	GPIO_SetBits(GPIOB, GPIO_Pin_12);
#define CLR_RST()	GPIO_ResetBits(GPIOB, GPIO_Pin_12);
